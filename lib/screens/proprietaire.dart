...
class _ProprietaireState extends State<Proprietaire> {
  ...
  final TextEditingController resetCtrl = TextEditingController(); // controller déplacé ici
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(icon: Logo(Logos.facebook_f, size: 35), onPressed: () {}),
                          IconButton(icon: Logo(Logos.github, size: 35), onPressed: () {}),
                          IconButton(icon: Logo(Logos.microsoft, size: 35), onPressed: () {}),
                        ],
                      ),
                      const SizedBox(height: 25.0),
  ...
  Future<void> login(BuildContext context) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const MapPage(role: 'Proprietaire')),
      );
  ...
  void showResetPasswordDialog(BuildContext context, TextEditingController emailController) {
    showDialog(
      context: context,
